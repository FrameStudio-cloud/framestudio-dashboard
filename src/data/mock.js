...
export const mockKeelPulse = {
  ...
  shops: [
    { id: "1", name: "Zuri Fashion", email: "info@zurifashion.co.ke", status: "active", plan: "starter", revenue: 5000, subscriptionExpiresAt: new Date(Date.now() + 45 * 86400000).toISOString() },
    { id: "2", name: "Mini Electricals", email: "minielec@gmail.com", status: "active", plan: "starter", revenue: 5000, subscriptionExpiresAt: new Date(Date.now() + 30 * 86400000).toISOString() },
    { id: "3", name: "Ancy Luxe", email: "ancy@ancyluxe.com", status: "active", plan: "pro", revenue: 8000, subscriptionExpiresAt: new Date(Date.now() + 60 * 86400000).toISOString() },
    { id: "4", name: "Campus Glow", email: "hello@campusglow.com", status: "active", plan: "starter", revenue: 5000, subscriptionExpiresAt: new Date(Date.now() + 20 * 86400000).toISOString() },
    { id: "5", name: "Lumière Hair", email: "lumiere@gmail.com", status: "active", plan: "beta", revenue: 1000, subscriptionExpiresAt: new Date(Date.now() + 3 * 86400000).toISOString() },
    { id: "6", name: "TechHive KE", email: "info@techhive.co.ke", status: "active", plan: "pro", revenue: 5000, subscriptionExpiresAt: new Date(Date.now() + 15 * 86400000).toISOString() },
    { id: "7", name: "Fresh Mart", email: "orders@freshmart.co.ke", status: "expired", plan: "free", revenue: 0, subscriptionExpiresAt: new Date(Date.now() - 5 * 86400000).toISOString() },
    { id: "8", name: "Urban Styles", email: "urban@styles.co.ke", status: "active", plan: "starter", revenue: 0, subscriptionExpiresAt: new Date(Date.now() + 10 * 86400000).toISOString() },
    { id: "9", name: "Gadget Hub", email: "sales@gadgethub.co.ke", status: "active", plan: "beta", revenue: 0, subscriptionExpiresAt: new Date(Date.now() + 2 * 86400000).toISOString() },
  ],
  approvals: [
